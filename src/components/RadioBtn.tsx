                            ...
                            <div className="container_block">
                                ...
                                <div className={`container_alert ${values.sum === "Оклад за месяц" && values.money ? "" : "disable"}`}>
                                    ...
                                    <Field
                                        ...
                                        visible={false}
                                    />
                                    <div><strong>{values.salary?.toLocaleString('ru')} ₽</strong> сотрудник будет получать на руки</div>
                                    <div><strong>{values.salaryEBDA?.toLocaleString('ru')} ₽</strong> НДФЛ, {percentNdfl}% от оклада</div>
                                    <div><strong>{values.ndfl?.toLocaleString('ru')} ₽</strong> за сотрудника в месяц</div>
